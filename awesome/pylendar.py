...
appprop = ["Pylendar", gtk.WINDOW_POPUP, 1020, 14, 0, 5, 15000, True]
...
nonworking = {
    1 : [["Новый год", 1],
	 ["Православное Рождество", 7],
         ["Старый новый год", 13],
	 ["Крещение - Святое Богоявление", 19],
	 ["День студентов - Татьянин день", 25]],
    2 : [["День Святого Валентина", 14],
	 ["День защитника Отечества", 23]],
    3 : [["Международный женский день", 8]],
    4 : [["День смеха / День дурака", 1]],
    5 : [["День весны и труда", 1],
	 ["День Победы", 9]],
    6 : [["День России", 12]],
    7 : [],
    8 : [],
